...
namespace RecipeApp
{
    ...
    public partial class Form1 : Form
    {
        ...
        AddForm addForm;
        public int jokaToine;
        string imgPath = Application.StartupPath + @"Resources\";
        ...
        {
            //List<Food> uCtrlJson = new List<Food>();
            //read .json
            NewFLPanel.Controls.Clear();
        ...
        private void FindBtn_Click(object sender, EventArgs e)
        {
            ...
            if (searchable.Count() > 0)
            {
                ...
                foreach (var i in search)
                {
                    ...
                    //listViewItem1.Items.Add(item);
                    //listView1.Font = new Font(listView1.Font, FontStyle.Regular);
                    jokaToine = jokaToine % 2;
                    jokaToine++;
                    Image img = Image.FromFile(Path.Combine(imgPath, i.imagePath));
                    RecipeItem uC = new RecipeItem()
                    {
                        FoodName = i.name,
                        DifficultyLabel = i.difficulty,
                    ...
                    if (jokaToine != 1)
                    {
                        uC.BackColor = Color.DarkSeaGreen;
                    }
                }
            }
            else
